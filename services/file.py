...
from models.models import Document, DocumentMetadata, DocumentMetadataForm, Source


async def get_document_from_file(file: UploadFile, request: DocumentMetadataForm) -> Document:
